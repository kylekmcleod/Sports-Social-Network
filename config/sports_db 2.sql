...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2025 at 02:16 AM
...
(61, 17, 'yo tester', NULL, '2025-03-21 00:58:51', '2025-03-21 00:58:51', 0, 0),
(62, 18, 'Yup new post who dis', NULL, '2025-03-21 01:04:38', '2025-03-21 01:04:38', 0, 0);
...
INSERT INTO `users` (`user_id`, `username`, `email`, `password_hash`, `first_name`, `last_name`, `profile_picture`, `bio`, `created_at`, `updated_at`, `followers_count`, `following_count`, `posts_count`) VALUES
(3, 'testuser1', 'testuser1@example.com', 'hashedpassword1', 'John', 'Doe', 'http://example.com/profile1.jpg', 'This is a test bio for John.', '2025-03-10 20:57:30', '2025-03-10 20:57:30', 0, 0, 0),
(4, 'testuser2', 'testuser2@example.com', 'hashedpassword2', 'Jane', 'Smith', 'http://example.com/profile2.jpg', 'This is a test bio for Jane.', '2025-03-10 20:57:30', '2025-03-10 20:57:30', 0, 0, 0),
(5, 'testuser3', 'testuser3@example.com', 'hashedpassword3', 'Mark', 'Johnson', 'http://example.com/profile3.jpg', 'This is a test bio for Mark.', '2025-03-10 20:57:30', '2025-03-10 20:57:30', 0, 0, 0),
(17, 's', 's@gmail.com', '$2y$10$EpugjwUdIIQHizt6j9aFe./9vZIlk04WXHvjE38y9YoFgcoc5Ify.', 's', 's', 'uploads/a3.PNG', NULL, '2025-03-15 20:37:31', '2025-03-21 00:58:51', 0, 0, 1),
(18, 'kylekmcleod', 'kylekmcleod1@gmail.com', '$2y$10$188KbpkbZd/miGmSbuPtl.5jWoO5KUxvnpGet.K1XboyNZFdPbCLm', 'Kyle', 'McLeod', NULL, NULL, '2025-03-19 20:20:19', '2025-03-21 01:04:38', 0, 0, 1);
